...
class CameraManager:
    def __init__(self, width=1920, height=1200, device="/dev/video0"):
        self.width = width
        self.height = height
        ...
        self.proc = subprocess.Popen(
            ['python3', '/home/jetson/streaming/arducam_tostdout.py'],
            stdout=subprocess.PIPE,
            bufsize=self.yuv_frame_size
        )

    def read(self):
        # YUV420p raw data를 그대로 읽기
